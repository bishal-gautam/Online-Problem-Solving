...
// cumulative frequency, this procedure will return the greatest one
//int bm = MX+2;
//int findG(int cumFre, int *BIT) {
//    int i=0;
//    for(i = 0; (bm != 0) && (i <= MX); bm >>= 1 ) {
//        int id = i + bm;
//        if (cumFre >= BIT[id]) {
//            i = id,cumFre -= BIT[id];
//        }
...
int findG(int cumFre, int *BIT) {
    int idx = 0;
    int bitMask = (1 << 15);
    int MaxVl = (bitMask << 1) - 1;
    while ((bitMask != 0) && (idx <= MaxVl )) {
