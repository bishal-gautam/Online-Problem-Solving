...
vector<data>v;
vector<int>G[MX+5];
int tmm,n,m,ar[MX+5],St[MX+5],Ed[MX+5],U[MX+5],Fr[MX+5],BIT[MX+5],MP[MX+5];
...
void Add(int p,int v) {
    for(int i=p; i<=tmm; i+=i&-i)BIT[i]+=v;
}
